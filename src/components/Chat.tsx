...
const KEYWORD_REPLIES: { pattern: RegExp; replies: string[] }[] = [
  ...
  {
    pattern: /占い|コーヒー豆|豆占い/,
    replies: [
      'ホームの「コーヒー豆占い」、1日1回だよ。豆を選ぶと今日の味わいが出る ☕',
      '占いというより、ひと息のきっかけ。ホームで豆を1つ選んでみて！',
      '同じ日の引き直しはなし。コーヒーも抽出は一度きり、だよ。',
    ],
  },
  {
  ...
  },
  {
    ...
    replies: [
      '猛暑つらいね… 今日は急がなくていいよ。クリエイティブの「明るいAI」に、涼しさプランのちょい技を書いたよ ☕',
      '夏物語編、小説コーナーに追加したよ。おじさんとワンちゃんとロボット君の午後。',
      '熱暴走はダメ。冷やして、のんびり。ロボット君冷却ゲームもあるよ 🌬️',
    ],
  },
  {
    pattern: /明るいAI|明るい|前を向|しんどい|つらい|不安|防災|備え/,
    replies: [
      'クリエイティブタブの「明るいAI」コーナー、用意したよ。暮らしを少し楽にする技をまとめてある 🌤️',
      'しんどいニュースのあとも、小さく前を向く一手を書いていくね。今日試せることだけ、のんびりどうぞ。',
      '防災リストや暑さ対策、AIに5分だけ相談する使い方も載せてあるよ。完璧じゃなくていいからね。',
    ],
  },
  {
    pattern: /ロボット|冷却|熱暴走/,
