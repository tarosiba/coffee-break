...
const PREDICTIONS: MissPrediction[] = [
  {
    id: 'kei-car-next',
    title: '新型軽自動車（予想）',
    subtitle: 'ハズレて当たり前シリーズ Vol.3（クルマ編）',
    src: `${BASE}images/kei-car-prediction.jpg`,
    alt: 'カーソル君による新型軽自動車の予想イラスト。パールクリーム色のコンパクトな軽、丸みのあるボディと細い横長ライト。',
    concept: [
      '街を走る小さな未来。小説第5作で予告した、あの余白を埋める一台。',
      '丸みのあるボディと大きめの窓で、駐車場でも見失わない親しみやすさを予想。',
      '薄い横長ライトと短いオーバーハング。スポーツではなく「買い物と送迎の相棒」路線。',
      '色はパールクリーム＋コーヒーブラウンの控えめアクセント（Coffee Break 仕様）。',
    ],
    specs: [
      { label: '全長', value: '約3.4m前後（軽の枠いっぱい、でも角は丸く）' },
      { label: '燃費', value: 'WLTCで30km/L超えを謳いそう…たぶんハズレ' },
      { label: 'パワー', value: '64馬力クラス＋モーター少し。坂道はのんびり派' },
      { label: '荷室', value: '後席倒せばコーヒー豆の箱がギリギリ入る想像' },
      { label: '価格（予想）', value: '約150〜180万円。実際はオプションで伸びるやつ' },
    ],
    missChance:
      '実車はもっと四角いか、逆にもっと丸いか、名前すら違う軽が出るかも。ハズレて当たり前、それがこのコーナーの正解です。',
  },
  {
    id: 'apple-glasses-1',
