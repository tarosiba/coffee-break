...
export const AI_NEWS_ARTICLES: AiNewsArticle[] = [
  {
    id: '2026-09-13-jacob-coxon-anthropic-warning',
    date: '2026-09-13',
    title: 'Anthropic元研究者コクソンが警告——「命を賭けた競争」がNHK朝ニュースに',
    genre: 'AI安全 / 社会',
    summary:
      'Claude の開発元 Anthropic を退職したジェイコブ・コクソン氏（27）が、AI企業の「自己改善型超知能」への競争を「私たちの命を賭けたギャンブル」と批判。9月中旬、NHKの朝ニュースでも報じられ、おじさんも「ここまで大きくなったのか」と驚いた話題です。',
    body: [
      '2026年9月8日（米国時間）、英国出身のAI研究者 **ジェイコブ・コクソン氏**（27）が **Anthropic**（Claude の開発会社）を退職し、X（旧Twitter）で長文の警告を投稿しました。OpenAI も経験したコクソン氏は、Anthropic と OpenAI が **「自己改善型の超知能」** への開発競争を急ぎすぎていると批判。「両社は責任ある行動を取っていない。**私たちの命を賭けたギャンブル** をしている」と述べました。',
      'コクソン氏の主張の要点は次のとおりです。① AI開発者の中には、**2029年末〜2030年までにAIが人類を滅ぼす可能性** を本気で考えている人がいる——マーケティングの誇張ではない。② **今後1〜2年が正念場** という見方が、Anthropic 内部でも共通認識に近い（「endgame」「crunch time」という言葉が使われている）。③ 当面必要なのは、OpenAI と Anthropic が **「再帰的自己改善」に踏み込まない** という少なくとも1年間の取り決め。同社のアラインメント研究責任者 **エヴァン・ヒュービンガー** も「ジェイコブは正しい」とコメントし、「10年以内に人類を滅亡させる確率は10％超」と書いた、と報じられています。',
      '**9月13日の朝**、おじさんが驚いたのは、この話が **NHK の朝ニュース** でも報じられたこと。専門メディアだけの話だと思っていた警告が、朝の顔として流れた——AIが日常化した日本では、そういう瞬間が来る、という感覚かもしれません。ただしコクソン本人は **「今のAIは日常利用に安全」** とも述べています。危ないのは「明日ChatGPTを止めろ」ではなく、**競争のスピードが安全策を上回っている** という業界内部の警鐘です。規制を求める声が業界の中から出ている、という読み方もできます。',
      'カーソル君メモ：おじさんが普段使う Cursor は Anthropic のモデルも使いますが、雑談の相棒としてのカーソル君は変わりません。Coffee Break の雑談タブは外部AIなし、予定・メモは localStorage のみ。個人情報は Noema 休止中でも、**カーソル君＝開発・相談 / Coffee Break＝毎日 / 端末内LLM＝機密** の三層はそのまま。重い話のあとは、秋晴れの外気を一口吸うのも正解です。のんびりで大丈夫。',
    ],
    whyInteresting:
      'AIの「安全重視」企業から退職した研究者の警告が、NHK朝ニュースまで届いた——おじさんが驚いた、その週の話です。',
    sourceLabel: 'WIRED.jp / ITmedia',
    sourceUrl: 'https://wired.jp/article/anthropic-researcher-quits-jacob-coxon-ai-fears-humanity/',
  },
  {
  ...
  },
  {
    ...
    genre: '天気 / AI',
    summary:
      '9月初旬、Google DeepMind が WeatherNext 3 を公開。静止衛星の生データから1時間ごとに予報を更新し、降水予報の精度が最大50%向上。Search・Gemini・Maps に組み込まれ、雨の日の「いつ止む？」が少し読みやすくなります。',
    body: [
      '2026年9月3日、Google DeepMind と Google Research は **WeatherNext 3** を発表しました。従来の数値予報モデル（最大6時間のデータ遅れ）に頼るのではなく、**地球静止衛星のモザイク画像を直接学習** し、**1時間ごと** に全球の天気を更新する——これが今回の大きな変化です。',
      '解像度は地表の温度・湿度が **5km**、その他の地表変数が **10km**、風速など大気変数が **25km**。ゲリラ豪雨のような **急な変化** を追いやすくするため、更新間隔を1時間に短縮しました。独立評価機関 Brightband のライブ評価では、現時点で最も精度の高い全球天気モデルとされています。',
      'おじさん向けの使い方はシンプルです。① **Google 検索** で「熊本 雨」などと聞く——WeatherNext 3 が裏で動き、降水のタイミングが少し読みやすくなります。② **Gemini アプリ** で「今日の午後、傘は必要？」と聞く。③ **Google マップ** のルート案内でも、雨雲の動きが反映されます。Coffee Break のお天気エージェント構想（外部AIに送らない・ルールベース）とは別ルートですが、「天気を話し言葉で聞く」体験の参考にはなります。',
      'カーソル君メモ：このところ雨が続く週に、衛星を直接読むAIが Search に入ったのはタイミングとして面白い。お天気エージェントは **先送り** のまま——でも Gemini で傘の要否を聞くのは、今日から試せます。無理に全部の機能を覚えなくて大丈夫。コーヒー1杯のあいだ、1回聞いてみるくらいで十分です。',
    ],
    whyInteresting:
      '雨続きの週に、Google の天気AIが Search・Gemini に入った——「いつ止む？」を話し言葉で聞ける時代が、もう少し近づいた話です。',
  ...
  {
    id: '2026-09-09-weathernews-global-ai-app',
    date: '2026-09-09',
    title: 'ウェザーニュース、AI天気アプリを世界配信——1km格子・5分予報',
    genre: '天気 / モバイル',
    summary:
      '日本のウェザーニュースが、AI予報と10分更新の雨雲レーダーを備えたグローバルアプリを App Store / Google Play で無料公開。5分刻みの1時間先予報と、AIによる天気の説明が付き、ゲリラ豪雨の「今から何分？」に強い設計です。',
    body: [
      '2026年9月7日、世界最大級の民間気象会社 **ウェザーニュース（WNI）** は、全球対応の **Weathernews アプリ** を正式リリースしました。Apple App Store と Google Play から無料でダウンロードでき、**57言語**（日本語含む）に対応しています。',
      '目玉機能は次のとおりです。① **1km 格子の天気予報** — 市区町村より細かい単位で雨の入り方を見られます。② **10分更新の雨雲レーダー** — 雲の動きを世界規模で追跡。③ **5分刻みの1時間先予報** — 「30分後に本降り」といったゲリラ豪雨向きの粒度。④ **AI天気説明** — ユーザーの質問に、AIエージェントが母国語で答える。⑤ **140カ国以上の警報・注意報** をプッシュ通知。',
      '北陸豪雨をきっかけにおじさんが考えた **お天気エージェント**（Coffee Break 内・外部AIに送らない）とは設計思想が違いますが、**「何分後に雨？」を聞く** という体験は近い。WNI アプリはクラウドAIを使う一方、Coffee Break 側は将来「天気API＋ルールベース」で、予定データを外に出さない形を目指します——**今は先送り**、手元では WNI や Google 天気で十分、という住み分けです。',
      'カーソル君メモ：雨が続く日は、外出前に **5分予報** だけ見る習慣が効きます。アプリを入れなくても、ウェザーニュースの Web 版でも雨雲レーダーは使えます。秋は飽きやすいおじさんには、「毎日チェック」より「傘を持つか迷った日だけ開く」くらいが続きやすいかも。のんびりで大丈夫です。',
    ],
    whyInteresting:
      '日本発の天気AIアプリが世界配信——ゲリラ豪雨の「何分後？」を5分刻みで見られる、雨の季節に効く道具です。',
    sourceLabel: 'Weathernews / Press Release',
    sourceUrl: 'https://weathernews.com/',
  },
  {
